...
function show_instructions() {
	...
	<h5>Scatter Plot</h5>\
	<p> Mouse over any data point to display a tooltip with information on that point.  Click any data point to select it and replace the information here with information on that food.  Click and drag to lasso multiple data points and filter the parallel coordinates plot.  Click a box in the color labels to recolor.  </p>\
